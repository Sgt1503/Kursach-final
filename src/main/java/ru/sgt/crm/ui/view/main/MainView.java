...
public class MainView extends VerticalLayout {
    ...
    public MainView(){
        ...
        H4 nameGopchang = new H4(gopchang.getName());
        H4 nameKadury = new H4(kadury.getName());
        H4 nameSushi = new H4(sushi.getName());
    ...
    public void descNotif(descrptAndImg descrptAndImg){
        ...
        Anchor more = new Anchor(descrptAndImg.getRoute(), "Подробнее о " + descrptAndImg.getName().toLowerCase());
        Notification descrptNotification = new Notification(decrpt, more);
